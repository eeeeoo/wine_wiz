...
white_starchy_vegetbale = Pairing.create([{category: carbs, wine: chardonnay}, {category: carbs, wine: semillon}, {category: carbs, wine: viognier}, {category: carbs, wine: marsanne}, {category: carbs, wine: roussanne}])
